    ...
    if (
    ...
    )
     {
        if (
            ...
            $reponseR->ajouterreponse($reponse);
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <?php echo $error; ?>
                           ...
                           <label for="name">Id Reponse</label>
                          ...
                          name="Idreponse"
                           type="int"
                            ...
                            <div class="mb-3">
                            <label for="messagee">Reponse</label>
                        <input
                          name="messagee"
                          type="varchar"
                          required pattern="[a-zA-Z-\.]{3,1000}"
                          ...
                          class="form-control validate"
                           />
                            ...
                            <input type="text" class="form-control" id="numreclamation" pattern="[0-9]+"  name="numreclamation" value="<?php  echo $_POST["nmr"]; ?>">

                            <div>
                              <button onmousedown="bleep.play()" class="btn btn-primary "  type="submit"> CONFIRMER</button>
                              <script>
                         var bleep=new Audio();
                         bleep.src="ab.mp3";
                      </script>
