...
echo $_GET['search'];
/*$UserC=new UserC();
$listeUtilisateur=$UserC->afficherUser();
 $bdd=  new PDO('mysql:host=localhost;dbname=bd_fassarli', 'root', '');
    if(isset($_POST['search'])) {
        
        $recherche=htmlspecialchars($_POST['search']);
        $listeUtilisateur=$pdo->query('SELECT * FROM users WHERE Nom_user LIKE "%'.$recherche.'%" OR Prenom_user LIKE "%'.$recherche.'%" ORDER BY ID_user DESC');
    }*/
    
	
	$ReclamationR=new ReclamationR();
	$listeReclamations=$ReclamationR->search($_GET['search']); 
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <form  method="POST" action="afficherreclamationRecherche.php">
              <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group input-group-outline">
              <label class="form-label"></label>
              <input type="text" class="form-control" name="search" placeholder="Type here...">
              <td class="ms-auto text-end">
				<a class="btn btn-link text-dark px-3 mb-0" type="submit" href="afficherreclamationRecherche.php"><i class="material-icons text-sm me-2">search</i>Search</a>
              </td>
            </div>
          </div>
          </form>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Num reclamation</th>
				  ...
				  <?php
				    //foreach($listeUtilisateur as $User){
                       ...
                       /* if ($listeUtilisateur->rowCount()>0){
                        while($User=$listeUtilisateur->fetch()){*/
			      ...
			      ?>
                      ...
                      <td>
                        <div class="align-middle text-center">
                          <div class="d-flex flex-column justify-content-center">
							 <h6 class="text-xs font-weight-bold mb-0" >     <?php echo $reclamation['numreclamation']; ?>
                          </div>
                        </div>
                      </td>
					...
					<div class="d-flex px-2 py-1">
					    <div>
                            <img src="../assetsback/img/team-2.jpg" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                        </div>
					  <div>                    
                        <h6 class="mb-0 text-sm" ><?php echo $reclamation['Prenom']; ?> <?php echo $reclamation['Nom']; ?> </p>
					  </div>
					</div>
					</td>
					...
					<td>
                        <div class="align-middle text-center">
                          <div class="d-flex flex-column justify-content-center">
							 <h6 class="text-xs font-weight-bold mb-0" >     <?php echo $reclamation['Email']; ?>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="align-middle text-center">
                          <div class="d-flex flex-column justify-content-center">
							 <h6 class="text-xs font-weight-bold mb-0" >     <?php echo $reclamation['datereclamation']; ?>
                          </div>
                        </div>
                      </td>
