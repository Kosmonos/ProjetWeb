<?php
	include '../Controller/ReponseR.php';
	$reponseR=new ReponseR();
	$listeReponses=$reponseR->classementreponse1(); 
    if (isset($_POST['search']) ) {
        $list = $reponseR->afficherbyname($_POST['search']);}
?>
?>
...
<div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <button><a href="afficherListeReclamations.php" class="btn btn-primary">Repondre aux autres reclamations</a></action>  </button>
        ...
        <tr>
            ...
            <td><?php echo $reponse['messagee']; ?></td>
            
            <td><?php echo $reponse['EmailClient']; ?></td>
    
            <td><?php echo $reponse['numreclamation']; ?></td>
            <td>
            <a href="modifierReponse.php?Idreponse=<?php echo $reponse['Idreponse']; ?>">Modifier</a>
        ...
        <button><a href="afficherListeReponses1.php" class="btn btn-primary">Tri Par ID</a></action>  </button>
        <button><a href="afficherListeReponses2.php" class="btn btn-primary">Tri Par Mail</a></action>  </button>
